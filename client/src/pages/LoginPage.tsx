              ...
              <CardHeader className="space-y-4 text-center pt-2 pb-6">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="space-y-2"
                  >
                    <CardTitle className="text-3xl font-anta font-bold tracking-[0.2em] text-[#1e293b] dark:text-white uppercase">
                  ...
                  {!isForgotPassword && !isResettingPassword && !showOtpInput && (
                    ...
                    >
                      <Button
                        ...
                        className="w-full h-12 gap-3 bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 hover:bg-black/10 dark:hover:bg-white/10 text-[#1e293b] dark:text-white rounded-xl transition-all duration-300"
                      >
                        ...
                        {isSignUp && (
                          <div className="space-y-2">
                            ...
                            <Input type="text" placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} required={isSignUp}
                              className="bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 text-[#1e293b] dark:text-white h-12 rounded-xl focus:ring-1 focus:ring-black/20 dark:focus:ring-white/20 transition-all placeholder:text-[#1e293b]/30 dark:placeholder:text-slate-600" />
                          </div>
                        )}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative group">
                            <Input type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required 
                              className="bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 text-[#1e293b] dark:text-white h-12 pr-12 rounded-xl focus:ring-1 focus:ring-black/20 dark:focus:ring-white/20 transition-all placeholder:text-[#1e293b]/30 dark:placeholder:text-slate-600" />
